    ...
    return (
        <>
            <div className="flex justify-center flex-col ">
                <div className="bg-white overflow-hidden w-[90%]  shadow rounded-lg border">
                    <div className="px-4 py-5 sm:px-6">
                        ...
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">
                            هذه بعض المعلومات عن المستخدم.                        </p>
                    </div>
                    <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
                        <dl className="sm:divide-y sm:divide-gray-200">
                            ...
                            <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt className="text-sm font-medium text-gray-500">البريد الالكتروني</dt>
                                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    majdfoudeh@gmail.com
                                </dd>
                            </div>
                            <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <button onClick={handleOpen} className="inline-flex w-fit mt-4 items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md">
                    <FaEdit className="h-5 w-5 ml-2" />
                    تعديل الملف الشخصي
                </button>
            </div>
            <Dialog open={open} handler={handleOpen}>
                <DialogHeader style={{ marginBottom: "-120px" }}  >تعديل الملف الشخصي </DialogHeader>
                                ...
                                <div className="flex justify-start mt-6">
                                    <DialogFooter>
                                        <div className="flex justify-around gap-5 mt-6">
                                            ...
                                            <Button type="submit" className='text-sm' variant="gradient" color="green" onClick={handleOpen}>
                                                <span>تحديث</span>
                                            </Button>
                                            <Button
                                                variant="text"
