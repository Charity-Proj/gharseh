        ...
        if (Object.keys(errors).length === 0) {
            try {
                ...
                const userData = {
                    ...
                    role: formData.role, // Include the chosen role in the form data
                };
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex items-center text-lg">
                                    <input type="text" name="name"
                                        value={formData.name}
                                        onChange={handleChange} id="username" className="border-b-2 appearance-none  text-right pr-10 border-black  w-full py-2 px-4 outline-none text-gray-700 leading-tight   focus:border-b-green-500" placeholder="الاسم الكامل" />
                                ...
                                <div className='w-full flex items-end  mr-2 justify-end'>{errors.name && <span className='text-red-600'>{errors.name}</span>}</div>
