...
import { FaUser, FaCog, FaFutbol, FaReceipt, FaHandHoldingHeart } from "react-icons/fa";
                ...
                <div className="h-full px-2 py-2 overflow-y-auto">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                <FaReceipt className="w-6 h-6 me-4" style={{ color: "#54B435" }} />
                        ...
                        <li>
                            <li>
                                ...
                                >
                                    <FaHandHoldingHeart className="w-7 h-7 me-4" style={{ color: "#54B435" }} />
                            ...
                            <a
                                ...
                                className="flex items-center p-2 rounded-lg hover:bg-black -100 dark:hover:bg-black-700"
                            >
                                <FiLogOut className="w-7 h-7 me-4" style={{ color: "#54B435" }} />
                                <span className="flex-1 ml-3 whitespace-nowrap">
                                    تسجيل خروج
                                </span>
