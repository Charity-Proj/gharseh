...
export default function NavBar() {
  ...
  return (
    <>
      <Navbar className="inset-0 z-10 h-max max-w-full rounded-none py-2 px-4" dir="rtl">
        <div className="flex items-center lg:justify-between md:justify-between justify-between text-blue-gray-900">
          ...
          <div className="flex items-end gap-4">
            ...
            <Link smooth={true} to="/Login"><Button
              variant="gradient"
              size="sm"
              color="green"
        ...
        <Collapse open={openNav}>
          {navList}
          <Button variant="gradient" color="green" size="sm" fullWidth className="bg-green-500 mb-2">
            <span>تسجيل دخول</span>
          </Button>
        </Collapse>
      </Navbar>
